...
"For the linear regression, not all variables are helpful to predict temperature. Ex: precipitation has a negative R2 value, which means the model predicts temperature with less accuracy than a constant value (horizontal line). However, the accuracy of the model's predictions improves as more and more variables are included.   "
