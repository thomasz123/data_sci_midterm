...
"For the linear regression, not all variables are helpful to predict temperature. Ex: Cloud cover has a low feature importance or coefficient value and a low r2 value. We can infer from that cloud cover is not that useful for predicting the temperature. "
